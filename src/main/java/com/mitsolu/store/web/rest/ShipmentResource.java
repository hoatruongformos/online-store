...
import com.mitsolu.store.repository.ShipmentRepository;
import com.mitsolu.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link com.mitsolu.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
