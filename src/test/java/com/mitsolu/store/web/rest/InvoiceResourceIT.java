...
import static com.mitsolu.store.web.rest.TestUtil.sameNumber;
...
import com.mitsolu.store.domain.enumeration.InvoiceStatus;
import com.mitsolu.store.domain.enumeration.PaymentMethod;
import com.mitsolu.store.repository.InvoiceRepository;
import com.mitsolu.store.service.InvoiceService;
...
class InvoiceResourceIT {
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.status(UPDATED_STATUS).paymentMethod(UPDATED_PAYMENT_METHOD).paymentDate(UPDATED_PAYMENT_DATE);
